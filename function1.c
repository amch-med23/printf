...
/**
 * print_octal - prints a unsigned number in octal notation
 * @types: arguments
...
/**
 * print_hexadecimal - prints a unsigned number to hexadecimal
 * @types: arguments
 * @buffer: array to handle print
 * @flags:counts active flags
 * @width: width
 ...
 * @types:  arguments
 * @map_to:aArray of values to map the number
 * @buffer: array to handle print
 * @flags:  counts active flags
